...
def main_app():        
    ...
    if "username" in st.session_state:
        ...
        st.header("Welcome to the Personal Fitness Tracker!")
    ...
    st.write("This calculator is given to check your BMI. If you don't know your BMI , you can use this calculator to find out your BMI and then you can use the BMI value as input to calculate your calories burned.")

    height = st.slider("Enter your (in cm) :", 0,250,175)
    weight = st.slider("Enter your weight (in kg) :", 0,250,60)
